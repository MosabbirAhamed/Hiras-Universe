  ...
  return (
    <main className="storefront-shell">
      <div className="site-container pb-16 pt-10 sm:pb-20 sm:pt-14 lg:pb-24 lg:pt-16">
        <header className="mb-10 border-b border-[var(--color-border)] pb-8 sm:mb-12 sm:flex sm:items-end sm:justify-between sm:gap-10 sm:pb-10">
          <div className="max-w-3xl">
            <p className="storefront-eyebrow mb-4">The full edit</p>
            <h1 className="font-serif text-4xl font-semibold leading-[1.05] text-[var(--color-heading)] sm:text-5xl lg:text-6xl">
              All products
            </h1>
          ...
          <p className="mt-6 text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--color-muted)] sm:mb-1 sm:mt-0">
        ...
        {visibleProducts.length > 0 ? (
          ...
          <div className="storefront-card flex min-h-[300px] flex-col items-center justify-center px-6 py-16 text-center sm:px-12">
            ...
            <h2 className="font-serif text-2xl font-semibold text-[var(--color-heading)]">The next edit is being prepared</h2>
