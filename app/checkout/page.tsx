    ...
    <main className="storefront-shell">
      <div className="site-container py-10 sm:py-12 lg:py-16">
        <div className="mb-10 border-b border-black/10 pb-7">
          ...
          <p className="mt-2 text-sm text-charcoal/55">Share your delivery details and choose how you would like to pay.</p>
        </div>

        {serverError && (
          <div className="mb-6 flex items-start justify-between rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-700 animate-fade-in">
            <div>
        ...
        <form onSubmit={handleOrderSubmit} className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <section className="storefront-card space-y-5 bg-white/60 p-5 sm:p-6">
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-32 space-y-5 rounded-[18px] border border-black/10 bg-[#fbfaf7] p-5 shadow-[0_18px_45px_rgba(65,49,37,0.08)] sm:p-6">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="storefront-button flex min-h-[50px] w-full items-center justify-center py-3.5 text-sm font-medium disabled:opacity-60"
              >
              ...
              <div className="space-y-2 border-t border-taupe/20 pt-4 text-xs text-charcoal/60">
                <div className="flex items-center gap-2">
                  <span className="text-mocha">•</span> Cash on delivery is available across Bangladesh
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-mocha">•</span> Delivery charge is calculated from your district
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-mocha">•</span> Track your order after it has been placed
                </div>
              </div>
            </div>
          </div>
